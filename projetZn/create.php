...
?>
        ...
        <form method="post">
            ...
            <div class="row mb-3">
            <label class="col-form-label col-sm-1" for="filieres">filieres:</label>
            <div class="col-sm-6">
                <select name='filiere' class="form-select">
                <option selected>choisis ta filiere</option>
           <?php

            include("filiere.php");
            $filieres = $filiere::selectAllfilieres('Cfilieres',$connection->conn);
            foreach($filieres as $filiere){
                echo "<option value='$filiere[id]' >$filiere[cityName]</option>";
